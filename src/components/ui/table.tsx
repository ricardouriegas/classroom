...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b border-[#4c4c6d]", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t bg-[#252538]/50 font-medium text-white [&>tr]:last:border-b-0 border-[#4c4c6d]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-[#4c4c6d] transition-colors hover:bg-[#252538]/50 data-[state=selected]:bg-[#252538]",
      className
    )}
    {...props}
  />
